    ...
    <main className='flex gap-[4vmin] flex-col items-center justify-between'>
      ...
      <div className='flex flex-col items-center bg-white bg-opacity-20 self-stretch gap-[3vmin] py-[2vmin]'>
        ...
        <div className='flex min-h-[15vmax] justify-evenly self-stretch my-[3vmin] group'>
          <div className='w-[12vmax] h-[12vmax] flex flex-col items-center bg-white rounded-full justify-center rounded-tr-none relative shadow-lg self-start gap-[1vmin] group-hover:translate-y-5 transition duration-500 ease-in-out'>
          ...
          <div className='w-[12vmax] h-[12vmax] flex flex-col items-center bg-white rounded-full justify-center rounded-bl-none relative shadow-lg self-end gap-[1vmin] group-hover:-translate-y-5 transition duration-500 ease-in-out'>
