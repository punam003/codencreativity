...
const AcknowledgeCard = ({ cardData }) => {
  return (
    <div className="flex bg-white min-w-[16vmax] min-h-[16vmax] items-center justify-evenly flex-col rounded-2xl hover:scale-110 hover:shadow-xl transition duration-300">
      <Image
        src={`/${cardData.icon}`}
